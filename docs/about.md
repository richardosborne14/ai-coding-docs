---
title: About
description: Who writes this guide, and why it's free.
---

# About

I'm Richard, and I build things with Claude for a living. I wrote this so you can do it too. If it works, you'll never need to call me. I can live with that.

---

## Me

I came to software the long way round: spreadsheets, then no-code tools, then building with AI. That's why this guide assumes nothing and explains the words as it goes.
...
2. Get mockups until I'd be happy if the app already existed.
3. Write the docs. They do 99% of the work.
4. One task per session, tested, with a confidence score.
5. Audit between phases, and fix what the audit finds before moving on.

The long version is [the rest of the site](/introduction).
...
This guide was written with Claude, using the method it describes. Claude did the typing. I did the arguing.
